            ...
            {userData && userData.user ? <Nav2 /> : <Nav />}
                <div className="aboutus-content">
                    ...
                    <div className = "contactUsText">
                        ...
                        <p>First of all <b>thank you</b> for stopping by <b>Musix</b>. <b>Musix</b> is built on providing the best customer service and the most user friendly as well as a simple user interface for customers like
                            you to explore. To be the best, we have to take compliments and constructive feedback to improve this application and be the best in the business. Below is a contact form which directly
